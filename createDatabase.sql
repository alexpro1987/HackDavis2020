...
create table mentors (mentorID INT NOT NULL AUTO_INCREMENT, PRIMARY KEY (mentorID), emailAddress varchar(255), username varchar(255), fk_yearID int, FOREIGN KEY (fk_yearID) REFERENCES years(yearID), fk_majorID int, FOREIGN KEY (fk_majorID) REFERENCES majors(majorID), hometown varchar(255));
create table students (studentID INT NOT NULL AUTO_INCREMENT, PRIMARY KEY (studentID), emailAddress varchar(255), username varchar(255), fk_yearID int, FOREIGN KEY (fk_yearID) REFERENCES years(yearID), fk_majorID int, FOREIGN KEY (fk_majorID) REFERENCES majors(majorID), hometown varchar(255));
